...
public class StudentServiceImplTest {
    ...
    public void testFindById(){
        ...
        assertThat(studentService.findStudentById("5506"),is(new Student("5506","James","Talor",5.0)));
        assertThat(studentService.findStudentById("5035"),is(new Student("5035","Andrew","Dope",4.0)));
        assertThat(studentService.findStudentById("5788"),is(new Student("5788","Kevin","Space",2.33)));
    }
    ...
    public void testGetAverageGpa() {
        ...
        StudentServiceImpl studentService = new StudentServiceImpl();
        studentService.setStudentDao(studentDao);
        assertThat(studentService.getAverageGpa(),is(3.532));
